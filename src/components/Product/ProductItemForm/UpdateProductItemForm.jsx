...
const UpdateProductItemForm = ({
  ...
  const handleImageDragEnd = (result) => {
    ...
    const reorderedFormImages = Array.from(
      control._formValues.productItems[itemIndex].images || []
    );
  ...
  const handleRemoveExistingImage = (imageIndex, imageFileName) => {
    setProductItemsPreviews((prev) => {
      const newPreviews = [...prev];
    ...
    if (imageFileName) {
      setProductItemImagesDelete((prev) =>
        [...prev, imageFileName].filter(Boolean)
      );
    }
    ...
    <div className="mb-6 border border-gray-300 p-6 rounded-sm">
        ...
        {productItemsFields.length > 1 && (
          <button
            ...
            onClick={() => {
              ...
              control._formValues.productItems.splice(itemIndex, 1);
              setValue("productItems", control._formValues.productItems);
            }}
            className="text-white bg-red-500 hover:bg-red-600 p-1 rounded-sm cursor-pointer"
            disabled={isLoading}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-6">
            ...
            <CustomSelect
              ...
              onChange={(e) => {
                setValue(`productItems[${itemIndex}].status`, e.target.value, {
                  shouldValidate: true,
                });
                if (e.target.value)
                  clearErrors(`productItems[${itemIndex}].status`);
              }}
              disabled={isLoading}
              withSearch={false}
                                    ...
                                    {(provided, snapshot) => (
                                      ...
                                      >
                                        ...
                                        <button
                                          ...
                                          onClick={() => {
                                            const itemId =
                                              control._formValues.productItems[
                                                itemIndex
                                              ]._id;
                                            const currentImages =
                                              control._formValues.productItems[
                          ...
                          img && (
                            ...
                            >
                              ...
                              <button
                                ...
                                onClick={() => {
                                  const itemId =
                                    control._formValues.productItems[itemIndex]
                                      ._id;
                                  const currentImages =
                                    control._formValues.productItems[itemIndex]
                                      .images || [];
                    ...
                    <input
                      ...
                      {...register(
                        `productItems[${itemIndex}].attributes[${attrIndex}].code`,
                        {
                          ...
                          minLength: {
                            value: 2,
                            message: "Mã thuộc tính phải có ít nhất 2 ký tự",
                          },
                          maxLength: {
                            value: 50,
                            message:
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setValue(`productItems[${itemIndex}].retailPrice`, rawValue, {
                    shouldValidate: true,
                  });
                  if (
                    rawValue &&
          ...
          <div className="space-y-6">
            <CustomSelect
              name={`productItems[${itemIndex}].branchId`}
              options={branchOptions}
              label="Chi nhánh"
              placeholder="Chọn chi nhánh"
              value={watch(`productItems[${itemIndex}].branchId`)}
              onChange={(e) => {
                setValue(
                  `productItems[${itemIndex}].branchId`,
                  e.target.value,
                  {
                    shouldValidate: true,
                  }
                ...
                if (e.target.value)
                  clearErrors(`productItems[${itemIndex}].branchId`);
              }}
              disabled={isLoading}
              withSearch={true}
              error={errors.productItems?.[itemIndex]?.branchId}
              register={register(`productItems[${itemIndex}].branchId`, {
