...
export const createCouponValidation = yup.object().shape({
  name: yup
    .string()
    .trim()
    .min(2, "Tên coupon phải có ít nhất ${min} ký tự")
    .max(100, "Tên coupon không được vượt quá ${max} ký tự")
    .required("Tên coupon là bắt buộc")
    .typeError("Tên coupon phải là chuỗi"),
...
export const updateCouponValidation = yup.object().shape({
  name: yup
    .string()
    .trim()
    .min(2, "Tên coupon phải có ít nhất ${min} ký tự")
